...
{
    public partial class VIewCancelOrderForm : Form
    {
        ...
        private void loadTable()
        {
            try
            {
                List<Order> orderList = _orderRepository.getAllOrdersByStatus("CANSEL");
                listViewCancelOrder.Items.Clear();
                ...
                foreach (var order in orderList)
                {
                    ...
                    listViewCancelOrder.Items.Add(listViewItem);
                }
        ...
        private void listViewRejectOrder_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                foreach (ListViewItem item in listViewCancelOrder.SelectedItems)
                {
                    loader.Visible = true;
        ...
        private void texSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                List<Model.Order> orderList = _orderRepository.getCustomerOrderByOrderCodeAndStatu("CANSEL", texSearch.Text);
                listViewCancelOrder.Items.Clear();
        ...
        {
            _pdfGenarate.pdfConverter(listViewCancelOrder, "cancel_orders.pdf");
