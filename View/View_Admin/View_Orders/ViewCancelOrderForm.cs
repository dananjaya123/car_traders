...
namespace car_traders.View.View_Admin.View_Orders
{
    public partial class VIewCancelOrderForm : Form
    {
        ...
        private void loadTable()
        {
            try
            {
                List<Order> orderList = _orderService.getAllOrdersByStatus("CANSEL");
        ...
        private void texSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                List<Model.Order> orderList = _orderService.getCustomerOrderByOrderCodeAndStatu("CANSEL", texSearch.Text);
                listViewCancelOrder.Items.Clear();
